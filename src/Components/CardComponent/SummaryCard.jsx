...
const SummaryCard = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0e325a] from-10% to-[#141c3a] to-100% rounded-lg border-[#1b3050] border-[1px] shadow-[2px_6px_20px_rgba(0,0,0,0.9)] pt-8 px-6 flex flex-col items-center justify-center h-full w-[98%] sm:mt-0 mt-12">
